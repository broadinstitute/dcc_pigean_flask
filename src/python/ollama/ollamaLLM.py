...
LIST_PATHWAY_FACTORS = [
    ...
    "MODULE_172, MODULE_209, MODULE_107, KEGG_COMPLEMENT_AND_COAGULATION_CASCADES, WP_COMPLEMENT_AND_COAGULATION_CASCADES",
    "REACTOME_PLASMA_LIPOPROTEIN_ASSEMBLY_REMODELING_AND_CLEARANCE, WP_CHOLESTEROL_METABOLISM, WP_STATIN_INHIBITION_OF_CHOLESTEROL_PRODUCTION, REACTOME_PLASMA_LIPOPROTEIN_REMODELING, REACTOME_METABOLISM_OF_VITAMINS_AND_COFACTORS",
    "MANALO_HYPOXIA_UP, YAMAZAKI_TCEB3_TARGETS_UP, PID_HIF1_TFPATHWAY, GOTZMANN_EPITHELIAL_TO_MESENCHYMAL_TRANSITION_UP, WP_PHOTODYNAMIC_THERAPY_INDUCED_HIF_1_SURVIVAL_SIGNALING"
]
